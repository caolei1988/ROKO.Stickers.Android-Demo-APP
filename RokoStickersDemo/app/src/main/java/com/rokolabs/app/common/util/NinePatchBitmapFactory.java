...
//    private static final int TRANSPARENT_COLOR = 0x00000000;
    ...
    public static NinePatchDrawable createNinePathWithCapInsets(Resources res, Bitmap bitmap, int top, int left, int bottom, int right, Rect padding, String srcName) {
        ByteBuffer buffer = getByteBuffer(top, left, bottom, right);
        NinePatchDrawable drawable = new NinePatchDrawable(res, bitmap, buffer.array(), padding, srcName);
        return drawable;
    }
