...
public class ImageResizer extends ImageWorker
{
    ...
    {
        return processBitmap(Integer.parseInt(data.getImageUrl(0)));
    }
     ...
     * @throws IOException 
     */
    public static Bitmap decodeSampledBitmapFromAsset(AssetManager am, String path, int reqWidth, int reqHeight) throws IOException
    {
...
//            }
        ...
        if(Utils.DEBUG)
            Log.d(TAG, "sampleSize: "+inSampleSize+" req:"+reqWidth+"x"+reqHeight+" real:"+width+"x"+height);
        return inSampleSize;
    }
}
